 ...
 async ambilListData() {
  ...
  async ambilListData2() {
    ...
    if (this.state.jumlahchat > this.state.jumlahbunyi) {
      ...
      let onlineSound = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/sound.mp3';
  ...
  render() {
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.navigate('Chatlibur', {nama: nikuser})
                  }>
                  <Image
                    source={Iconmail}
                    style={{
                ...
                <View style={{marginTop: 15}}>
                  <Menu
                    ...
                    <MenuItem
                      onPress={() =>
                        this.props.navigation.navigate('Akunlibur', {
                          nik: nikuser,
                          nama: nama,
                          no_telp: no_telp,
                        })
                    ...
                    <MenuItem
                      onPress={() =>
                        this.props.navigation.navigate('Riwayatlibur', {
                          nik: nikuser,
                          nama: nama,
                          no_telp: no_telp,
                        })
          ...
          <View style={styles.container}>
            ...
            <View style={{marginTop: 3}}>
              ...
              <View
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.replace('Notivelibur', {
                      nikuser: nikuser,
                    })
                  }>
                  <View
   ...
   <TouchableOpacity
                  style={{marginTop: 20}}
                   onPress={() => Linking.openURL('https://youtu.be/4wXFEYAZSxIf')}>
                  <Text
                    style={{
                      textAlign: 'center',
                      fontSize: 18,
