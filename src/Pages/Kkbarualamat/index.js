        ...
        <ScrollView style={{backgroundColor: 'white'}}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
            <TouchableOpacity
              ...
              style={{marginBottom: 0, ...styles.headerOff}}>
          ...
          <View style={{marginHorizontal: 20}}>
		         ...
		         <Text style={{marginBottom: 20, color: 'grey'}}>Data Kepala Keluarga</Text>
		      <TextInput
              ...
              theme={{roundness: 10}}
              value={this.state.nikkepalakk}
              onChangeText={text => this.setState({nikkepalakk: text})}
            />
            <TextInput
              ...
              style={{backgroundColor: 'white', marginBottom: 25}}
              theme={{roundness: 10}}
              value={this.state.namakepalakk}
              onChangeText={text => this.setState({namakepalakk: text})}
            />
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
			...
			<TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('KkbaruData', {
                  nikuser: nikuser,
                  kkbarupmhon: kkbarupmhon,
                  nikpmhon: nikpmhon,
                  namapmhon: namapmhon,
                  ...
                  kwnpmhon: kwnpmhon,
				         selectedcat12: selectedcat12,
				      nikkepalakk: this.state.nikkepalakk,
					      namakepalakk: this.state.namakepalakk,
