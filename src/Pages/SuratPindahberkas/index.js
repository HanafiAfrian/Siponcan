...
export default class SuratPindahberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/suratpindah.php';
  }
  ...
  async ambilListData1() {
    ...
    if (this.state.jumlah == 1) {
      ...
      setTimeout(() => {
        alert('Lanjut Ke Formulir Peristiwa Penting Pengurangan Kerena Pindah');
        this.props.navigation.replace('KKPPSuratPindah2', {
          nikuser: nikuser,
          nikpmhon: nikpmhon,
          namapmhon: namapmhon,
          nokkpmhon: nokkpmhon,
    ...
    return (
      <View style={styles.container}>
        ...
        <WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/suratpindah.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
        ...
        />
		 <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('SuratPindahtujuan', {
                nikuser: nikuser,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
                nokkpmhon: nokkpmhon,
