...
export default class Kkbaruberkas extends Component {
  constructor(props) {
    super(props);
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/kkbaru.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/kkbaru.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
        ...
        />
		  ...
		  <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('KkbaruData', {
                nikuser: nikuser,
