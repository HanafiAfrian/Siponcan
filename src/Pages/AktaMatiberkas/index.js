...
export default class AktaMatiberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/aktemeninggal.php';
  }
  ...
  async ambilListData1() {
    ...
    if (this.state.jumlah == 1) {
      ...
      setTimeout(() => {
        alert('Lanjut Ke Formulir Peristiwa Penting Pengurangan Karena Kematian');
        this.props.navigation.replace('KKPPMati2', {
          nikuser: nikuser,
          nikpmhon: nikpmhon,
          namapmhon: namapmhon,
          nokkpmhon: nokkpmhon,
    ...
    return (
      <View style={styles.container}>
        ...
        <WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/aktemeninggal.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
        ...
        />
		 <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('AktaMatisaksi', {
                nikuser: nikuser,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
                nokkpmhon: nokkpmhon,
