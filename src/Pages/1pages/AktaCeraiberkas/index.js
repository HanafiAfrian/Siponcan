...
export default class AktaCeraiberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://mutawif.co.id/apk/siponcan/api/aktecerai.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View>
          <ScrollView>
            <View
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.replace('AktaCeraiberkas', {
                    nikuser: nikuser,
                    nikpmhon: nikpmhon,
                    namapmhon: namapmhon,
                    nokkpmhon: nokkpmhon,
        ...
        <WebView
          ...
          source={{
            uri:
              'https://mutawif.co.id/apk/siponcan/aktecerai.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
