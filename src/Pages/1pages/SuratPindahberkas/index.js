...
export default class SuratPindahberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://mutawif.co.id/apk/siponcan/api/suratpindah.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
          ...
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('SuratPindahasal', {
                nikuser: nikuser,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
                nokkpmhon: nokkpmhon,
          ...
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('SuratPindahberkas', {
                nikuser: nikuser,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
                nokkpmhon: nokkpmhon,
        ...
        <WebView
          ...
          source={{
            uri:
              'https://mutawif.co.id/apk/siponcan/suratpindah.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
