...
export default class Kkgantikplkeluargaberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://mutawif.co.id/apk/siponcan/api/kkgantikk.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('Kkgantikplkeluargaberkas', {
                nikuser: nikuser,
                kkbarupmhon: kkbarupmhon,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
        ...
        <WebView
          ...
          source={{
            uri:
              'https://mutawif.co.id/apk/siponcan/kkgantikk.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
