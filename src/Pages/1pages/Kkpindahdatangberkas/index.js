...
export default class Kkpindahdatangberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://mutawif.co.id/apk/siponcan/api/kkpindahdatang.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('Kkpindahdatang', {
                nikuser: nikuser,
          ...
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('Kkpindahdatangberkas', {
                nikuser: nikuser,
                kkbarupmhon: kkbarupmhon,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
        ...
        <WebView
          ...
          source={{
            uri:
              'https://mutawif.co.id/apk/siponcan/kkpindahdatang.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
