...
export default class AktaMatiberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://mutawif.co.id/apk/siponcan/api/aktemeninggal.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('AktaMatijenazah', {
                nikuser: nikuser,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
                nokkpmhon: nokkpmhon,
          ...
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('AktaMatiberkas', {
                nikuser: nikuser,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
                nokkpmhon: nokkpmhon,
        ...
        <WebView
          ...
          source={{
            uri:
              'https://mutawif.co.id/apk/siponcan/aktemeninggal.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
