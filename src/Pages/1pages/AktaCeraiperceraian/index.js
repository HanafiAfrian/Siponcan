        ...
        <ScrollView style={{backgroundColor: 'white', paddingBottom: 70}}>
          ...
          <View style={{marginHorizontal: 20}}>
            ...
            <TextInput
              ...
              activeOutlineColor="#005b9f"
              right={
                <TextInput.Icon icon="calendar" onPress={this.datepicker2} />
              }
              style={{backgroundColor: 'white', marginBottom: 25}}
              theme={{roundness: 10}}
            ...
            <TextInput
              ...
              activeOutlineColor="#005b9f"
              right={
                <TextInput.Icon icon="calendar" onPress={this.datepicker3} />
              }
              style={{backgroundColor: 'white', marginBottom: 25}}
              theme={{roundness: 10}}
              value={pilih_tanggal_selesai1}
              onChangeText={text =>
                this.setState({pilih_tanggal_selesai1: text})
              }
              onFocus={this.datepicker3}
              showSoftInputOnFocus={false}
            />
