...
export default class Kkperubahanberkas extends Component {
  constructor(props) {
    super(props);
    ...
    this.url1 = 'https://mutawif.co.id/apk/siponcan/api/kkperubahandata.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{marginHorizontal: 20}}>
          <View>
            <View
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.replace('Kkperubahanberkas', {
                    nikuser: nikuser,
                    nikpmhon: nikpmhon,
                    namapmhon: namapmhon,
                    nokkpmhon: nokkpmhon,
        ...
        <WebView
          ...
          source={{
            uri:
              'https://mutawif.co.id/apk/siponcan/kkperubahandata.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
