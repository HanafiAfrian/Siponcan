...
export default class Kkpenambahananakberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://mutawif.co.id/apk/siponcan/api/kktambahanak.php';
  }
      ...
      <View style={styles.container}>
        ...
        <View style={{marginHorizontal: 20}}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.replace('Kkpenambahananakberkas', {
                  nikuser: nikuser,
                  nikpmhon: nikpmhon,
                  namapmhon: namapmhon,
                  nokkpmhon: nokkpmhon,
        ...
        <WebView
          ...
          source={{
            uri:
              'https://mutawif.co.id/apk/siponcan/kktambahanak.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
