        ...
        <ScrollView style={{backgroundColor: 'white'}}>
          ...
          <View style={{marginHorizontal: 20}}>
            ...
            <TextInput
              ...
              onChangeText={text => this.setState({nikanak: text})}
            />
            <TextInput
            ...
            />
            <TextInput
              label="Hari Kelahiran (anak)"
              mode="outlined"
              activeOutlineColor="#005b9f"
              style={{backgroundColor: 'white', marginBottom: 25}}
              theme={{roundness: 10}}
              value={this.state.harilahir}
              onChangeText={text => this.setState({harilahir: text})}
            />
