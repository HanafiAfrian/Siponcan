...
export default class Kkbaruberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://mutawif.co.id/apk/siponcan/api/kkbaru.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
          ...
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('Kkbarualamat', {
                nikuser: nikuser,
                kkbarupmhon: kkbarupmhon,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
          ...
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('Kkbaruberkas', {
                nikuser: nikuser,
                kkbarupmhon: kkbarupmhon,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
        ...
        <WebView
          ...
          source={{
            uri:
              'https://mutawif.co.id/apk/siponcan/kkbaru.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
