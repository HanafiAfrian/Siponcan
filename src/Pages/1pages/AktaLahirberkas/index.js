...
export default class AktaLahir extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://mutawif.co.id/apk/siponcan/api/aktalahir.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{marginHorizontal: 20}}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <View
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.replace('AktaLahirsaksi', {
                    nikuser: nikuser,
                    nikpmhon: nikpmhon,
                    namapmhon: namapmhon,
                    nokkpmhon: nokkpmhon,
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.replace('AktaLahirayah', {
                    nikuser: nikuser,
                    nikpmhon: nikpmhon,
                    namapmhon: namapmhon,
                    nokkpmhon: nokkpmhon,
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.replace('AktaLahiranak', {
                    nikuser: nikuser,
                    nikpmhon: nikpmhon,
                    namapmhon: namapmhon,
                    nokkpmhon: nokkpmhon,
        ...
        <WebView
          ...
          source={{
            uri:
              'https://mutawif.co.id/apk/siponcan/aktalahir.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
