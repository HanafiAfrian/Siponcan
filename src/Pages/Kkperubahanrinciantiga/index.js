  ...
  klikSimpan() {
	  ...
	  var namapmhon = this.props.route.params.namapmhon;
	   var nokkpmhon = this.props.route.params.nokkpmhon;
        ...
        var nikpmhon3 = this.state.nikpmhon3;
        var namapmhon3 = this.state.namapmhon3;
        var shdk3 = this.state.selectedcat;
        var ket3 = this.state.ket3;
      ...
      fetch(urlAksi, {
        ...
        .then(responseJson => {
          if (responseJson == 'true') {
            ...
            this.props.navigation.replace('Kkperubahanrincianempat',{nikuser:nikuser,
			...
			nikpmhon3 :this.state.nikpmhon3,
        namapmhon3 : this.state.namapmhon3,
         shdk3 : this.state.selectedcat,
         ket3 : this.state.ket3,
