  ...
  klikSimpan() {
	  ...
	  var namapmhon = this.props.route.params.namapmhon;
	   var nokkpmhon = this.props.route.params.nokkpmhon;
        ...
        var nikpmhon7 = this.state.nikpmhon7;
        var namapmhon7 = this.state.namapmhon7;
        var shdk7 = this.state.selectedcat;
        var ket7 = this.state.ket7;
      ...
      fetch(urlAksi, {
        ...
        .then(responseJson => {
          if (responseJson == 'true') {
            ...
            this.props.navigation.replace('Kkperubahanrinciantujuh',{nikuser:nikuser,
        ...
        namapmhon5 : this.props.route.params.namapmhon5,
		 ...
		 nikpmhon6 : this.props.route.params.nikpmhon6,
         namapmhon6 : this.props.route.params.namapmhon6,
         shdk6 : this.props.route.params.shdk6,
         ket6 : this.props.route.params.ket6,
		 
		  nikpmhon7 : this.state.nikpmhon7,
        namapmhon7 : this.state.namapmhon7,
        shdk7 : this.state.selectedcat,
        ket7 : this.state.ket7,
 ...
 var nikpmhon6 = this.props.route.params.nikpmhon6;
	  var namapmhon6 = this.props.route.params.namapmhon6;
	   var shdk6 = this.props.route.params.shdk6;
	    var ket6 = this.props.route.params.ket6; 


 var nikpmhon7 = this.props.route.params.nikpmhon7;
	  var namapmhon7 = this.props.route.params.namapmhon7;
	   var shdk7 = this.props.route.params.shdk7;
	    var ket7 = this.props.route.params.ket7; 		
        ...
        <ScrollView style={{backgroundColor: 'white'}}>
		 ...
		 <Text></Text>
            ...
            <TextInput
              ...
              theme={{roundness: 10}}
               value={shdk6}
                onChangeText={text => this.setState({shdk6: text})}
            />
            <TextInput
              label="Keterangan"
              mode="outlined"
      ...
      Status Hubungan Dalam Keluarga
          ...
          <View
            ...
            <TextInput
              ...
              theme={{roundness: 10}}
			     value={ket7}
                onChangeText={text => this.setState({ket7: text})}
            />
   <TouchableOpacity
