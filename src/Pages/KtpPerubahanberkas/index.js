...
export default class KtpPerubahanberkas extends Component {
  constructor(props) {
    super(props);
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/ktpperubahan.php';
  }
...
var alasanpengajuan = this.props.route.params.alasanpengajuan;
    return (
    <View style={styles.container}>
        <View style={styles.headerTitle}>
          ...
          <Text
            ...
            Kartu Tanda Penduduk Perubahan
          </Text>
        </View>
       ...
       <WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/ktpperubahan.php?nikuser=' +
              nikuser +
			   '&nikpmhon=' +
              nikpmhon +
			    '&namapmhon=' +
        ...
        />
		  ...
		  <TouchableOpacity
                onPress={() =>
                  this.props.navigation.navigate('KtpPerubahandata', {nikuser:nikuser,
				nikuser: nikuser,
