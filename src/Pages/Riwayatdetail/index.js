...
klikSimpan() {
    ...
    fetch(urlAksi, {
      ...
      .then(responseJson => {
        ...
        this.props.navigation.replace('Home', {nikuser: nik});
      });
  }
  render() {
    var nik = this.props.route.params.nik;
    ...
    if (status == 'Verifikasi') {
      this.props.navigation.replace('Riwayat', {nik: nik});
    } 
...
else if (jenis == 'Kartu Tanda Penduduk Hilang') {
      this.props.navigation.replace('Riwayatdetailktpkia', {nik: nik});
    }
    
    
    else if (jenis == 'Kartu Tanda Penduduk Rusak') {
      this.props.navigation.replace('Riwayatdetailktpkia', {nik: nik});
    }

else if (jenis == 'Kartu Tanda Penduduk Perubahan') {
      this.props.navigation.replace('Riwayatdetailktpkia', {nik: nik});
    }	
	else if (jenis == 'Kartu Identitas Anak') {
      this.props.navigation.replace('Riwayatdetailktpkia', {nik: nik});
    }
            ...
            <View
              ...
              <View style={{}}>
			   ...
			   <TouchableOpacity
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.replace('Riwayatsendemail', {
                      nik: nik,
                      jenis: jenis,
                      status: status,
                      creat_at: creat_at,
                  ...
                  <View style={styles.boxShadow}>
                    ...
                    />
                    <Text style={styles.dari}>Kirim Ke E-mail</Text>
                  </View>
                </TouchableOpacity>
              </View>
              <View style={{}}>
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.replace('Riwayatsendpos', {
                      nik: nik,
                      jenis: jenis,
                      status: status,
                      creat_at: creat_at,
