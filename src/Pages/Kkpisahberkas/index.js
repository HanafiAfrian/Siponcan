...
export default class Kkhilangberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/kkpisah.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/kkpisah.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
        ...
        />
		          <TouchableOpacity
            onPress={() =>
              this.props.navigation.navigate('KKPisahDataIsian', {
                nikuser: nikuser,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
                nokkpmhon: nokkpmhon,
