...
export default class Kkperubahanrincian extends Component {
 ...
 this.url = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/kkbarudata.php';
  }
  ...
  klikSimpan() {
   ...
   var nikkepalakk = this.props.route.params.nikkepalakk;
   var namakepalakk = this.props.route.params.namakepalakk;
    ...
    var alamatpmhon = this.props.route.params.alamatpmhon;
        ...
        var nikpmhon1 = this.state.nikpmhon1;
        var namapmhon1 = this.state.namapmhon1;
        var shdk1 = this.state.selectedcat;
        var ket1 = this.state.ket1;
      ...
      fetch(urlAksi, {
        ...
        body:
          ...
          nikuser +
          '&nikpmhon1=' +
          this.state.nikpmhon1 +
          '&namapmhon1=' +
          this.state.namapmhon1 +
          '&shdk1=' +
          shdk1 +
		   '&data1=' +
          data1 ,
        ...
        .then(responseJson => {
          if (responseJson == 'true') {
            ...
            this.props.navigation.replace('KkbaruDataDua',{nikuser:nikuser,  kkbarupmhon  : kkbarupmhon ,    nikpmhon : nikpmhon ,     namapmhon : namapmhon ,    nokkpmhon : nokkpmhon ,      umurpmhon :  umurpmhon ,     kwnpmhon : kwnpmhon , selectedcat12 : selectedcat12 ,      nikkepalakk: nikkepalakk ,    namakepalakk : namakepalakk ,    kecpmhon : kecpmhon ,   kelpmhon : kelpmhon ,    alamatpmhon: alamatpmhon ,
			
			
			
			nikpmhon1 : nikpmhon1, namapmhon1:namapmhon1, shdk1:shdk1, data1:data1, ket1:ket1
			});
...
klikSimpan1() {
   ...
   this.props.navigation.replace('Kkbaruberkas',{nikuser:nikuser,  kkbarupmhon  : kkbarupmhon ,    nikpmhon : nikpmhon ,     namapmhon : namapmhon ,    nokkpmhon : nokkpmhon ,      umurpmhon :  umurpmhon ,     kwnpmhon : kwnpmhon ,   selectedcat12 : selectedcat12 ,    nikkepalakk: nikkepalakk ,    namakepalakk : namakepalakk ,    kecpmhon : kecpmhon ,   kelpmhon : kelpmhon ,    alamatpmhon: alamatpmhon ,
