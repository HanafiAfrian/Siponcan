...
export default class KtpPerubahan extends Component {
  constructor(props) {
    super(props);
    this.state = {
      show: false,
      ...
      <SafeAreaView style={styles.container}>
        ...
        onValueChange={this.onValueChangeCat.bind(this)}
          ...
          <TextInput
            ...
            style={{backgroundColor: 'white', marginBottom: 25}}
            theme={{roundness: 10}}
            value={this.state.alasanpengajuan}
            onChangeText={text => this.setState({alasanpengajuan: text})}
          />
			  ...
			  <TouchableOpacity
         onPress={() =>
                    this.props.navigation.navigate('KtpPerubahan', {
                      nikuser: nikuser,
			...
			<TouchableOpacity
        onPress={() =>
                    this.props.navigation.navigate('KtpPerubahanberkas', {
                      nikuser: nikuser,
                      nikpmhon: nikpmhon,
                      namapmhon: namapmhon,
                      nokkpmhon: nokkpmhon,
				...
				alasanpengajuan : this.state.alasanpengajuan,
