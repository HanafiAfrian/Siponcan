...
export default class AktaPengakuananakberkas extends Component {
  constructor(props) {
    super(props);
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/aktapengakuananak.php';
  }
componentDidMount() {
    this.ambilListData1();
  }
...
var nikibukandung = this.props.route.params.nikibukandung;
    ...
    return (
      ...
      <WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/aktapengakuananak.php?nikuser=' +
              nikuser +
			   '&nikpmhon=' +
              nikpmhon +
			    '&namapmhon=' +
        ...
        />
		  <TouchableOpacity
                onPress={() => this.props.navigation.navigate('AktaPengakuananakisian', {nikuser: nikuser,
                      nikpmhon: nikpmhon,
                      namapmhon: namapmhon,
                      nokkpmhon: nokkpmhon,
                      umurpmhon: umurpmhon,
