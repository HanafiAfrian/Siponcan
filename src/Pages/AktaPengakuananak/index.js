...
export default class AktaPengakuananak extends Component {
  constructor(props) {
    super(props);
   this.state = {
      show: false,
        ...
        <ScrollView
          ...
          />
		   <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
			  ...
			  <TouchableOpacity
         onPress={() =>
                    this.props.navigation.navigate('AktaPengakuananakpm', {
                      nikuser: nikuser,
			...
			<TouchableOpacity
        onPress={() =>
                    this.props.navigation.navigate('AktaPengakuananakisian', {
                      nikuser: nikuser,
                      nikpmhon: nikpmhon,
                      namapmhon: namapmhon,
                      nokkpmhon: nokkpmhon,
