  ...
  klikSimpan() {
	  ...
	  var namapmhon = this.props.route.params.namapmhon;
	   var nokkpmhon = this.props.route.params.nokkpmhon;
        ...
        var nikpmhon2 = this.state.nikpmhon2;
        var namapmhon2 = this.state.namapmhon2;
        var shdk2 = this.state.selectedcat;
        var ket2 = this.state.ket2;
      ...
      fetch(urlAksi, {
        ...
        .then(responseJson => {
          if (responseJson == 'true') {
            ...
            this.props.navigation.replace('Kkperubahanrinciantiga',{nikuser:nikuser,
			nikpmhon : nikpmhon, namapmhon : namapmhon,  nokkpmhon: nokkpmhon, umurpmhon:umurpmhon , kwnpmhon, kwnpmhon,
			nikpmhon1 : this.props.route.params.nikpmhon1, namapmhon1:this.props.route.params.namapmhon1, shdk1:this.props.route.params.shdk1, data1:'data1', ket1:this.props.route.params.ket1, nikpmhon2: nikpmhon2, namapmhon2:namapmhon2, shdk2:shdk2 ,ket2:ket2, data2:data2
			});
      ...
      Status Hubungan Dalam Keluarga
          ...
          <View
            ...
            <TextInput
              ...
              style={{backgroundColor: 'white', marginBottom: 25}}
              theme={{roundness: 10}}
			     value={this.state.ket2}
                onChangeText={text => this.setState({ket2: text})}
            />
   <TouchableOpacity
