...
export default class Kkperubahanrincian extends Component {
  constructor(props) {
    ...
    this.url = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/kkpisahdata.php';
  }
      ...
      fetch(urlAksi, {
        ...
        .then(responseJson => {
          if (responseJson == 'true') {
            ...
            this.props.navigation.replace('KKPisahDataIsianDua',{nikuser:nikuser,
      ...
      fetch(urlAksi, {
        ...
        .then(responseJson => {
          if (responseJson == 'true') {
            ...
            this.props.navigation.replace('Kkpisahberkas',{nikuser:nikuser,
			nikpmhon : nikpmhon, namapmhon : namapmhon,  nokkpmhon: nokkpmhon, umurpmhon:umurpmhon , kwnpmhon, kwnpmhon,			
			});
          } else if (responseJson == 'false') {
            alert('NIK Sudah Terdaftar');
