...
export default class Kiaberkas extends Component {
  constructor(props) {
    super(props);
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/kia.php';
  }
...
var namaibu = this.props.route.params.namaibu;
 ...
 <WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/kia.php?nikuser=' +
              nikuser +
               '&nikpmhon=' +
              nikpmhon +
			    '&namapmhon=' +
        ...
        />
		<TouchableOpacity
                onPress={() => this.props.navigation.navigate('Kia', {nikuser:nikuser,
