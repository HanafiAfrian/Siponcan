...
export default class KtpRusakberkas extends Component {
  constructor(props) {
    super(props);
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/ktprusak.php';
  }
 componentDidMount() {
    this.ambilListData1();
  }
 ...
 var nikpr = this.props.route.params.nikpr;
  var namapr = this.props.route.params.namapr;
   var temptlahir = this.props.route.params.temptlahir;
	...
	var rusakkarena = this.props.route.params.rusakkarena;
...
<WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/ktprusak.php?nikuser=' +
              nikuser +
             '&nikpmhon=' +
              nikpmhon +
			    '&namapmhon=' +
        ...
        />
		 ...
		 <TouchableOpacity
                onPress={() => this.props.navigation.navigate('KtpRusakdata', {  nikuser: nikuser,
                      nikpmhon: nikpmhon,
                      namapmhon: namapmhon,
                      nokkpmhon: nokkpmhon,
                      umurpmhon: umurpmhon,
