...
export default class Kkhilangberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/kkrusak.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/kkrusak.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
        ...
        />
		 <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.navigate('Kkrusakdata', {
                      nikuser: nikuser,
                      nikpmhon: nikpmhon,
                      namapmhon: namapmhon,
                      nokkpmhon: nokkpmhon,
