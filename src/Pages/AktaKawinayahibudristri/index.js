     ...
     Akta Perkawinan
        ...
        <ScrollView
          ...
          showsVerticalScrollIndicator={false}>
		     ...
		     <Text style={{marginBottom: 20}}>Data Ayah Dari Istri</Text>
          <TextInput
         ...
         onChangeText={text => this.setState({nik_ayah_is: text})}
          ...
          <TextInput
            label="Nama Lengkap Ayah Dari Istri  "
            mode="outlined"
            activeOutlineColor="#005b9f"
            style={{backgroundColor: 'white', marginBottom: 25}}
            theme={{roundness: 10}}
          ...
          />
		      <Text style={{marginBottom: 20}}>Data Ibu Dari Istri</Text>
         ...
         onChangeText={text => this.setState({nik_ibu_is: text})}
          ...
          <TextInput
            label="Nama Lengkap Ibu Dari Istri  "
            mode="outlined"
            activeOutlineColor="#005b9f"
            style={{backgroundColor: 'white', marginBottom: 25}}
            theme={{roundness: 10}}
          ...
          />
           <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
			  ...
			  <TouchableOpacity
         onPress={() =>
                    this.props.navigation.navigate('AktaKawinayahibudrsuami', {
                      nikuser: nikuser,
