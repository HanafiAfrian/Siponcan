...
export default class Kkhilangberkas extends Component {
  constructor(props) {
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/kknumpangdalamkk.php';
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/kknumpangdalamkk.php?nikuser=' +
              nikuser +
              '&nikpmhon=' +
              nikpmhon +
              '&namapmhon=' +
        ...
        />
		 <TouchableOpacity
            onPress={() =>
              this.props.navigation.replace('KknumpangdalamkkData', {
                nikuser: nikuser,
                nikpmhon: nikpmhon,
                namapmhon: namapmhon,
                nokkpmhon: nokkpmhon,
