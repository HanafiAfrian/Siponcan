...
export default class AktaPengangkatananakberkas extends Component {
  constructor(props) {
    super(props);
    ...
    this.url1 = 'https://siponcan.disdukcapilsibolga.id/siponcan/api/aktapengangkatanank.php';
  }
 componentDidMount() {
    this.ambilListData1();
  }
  ...
  render() {
    ...
    var penerbit = this.props.route.params.penerbit;
		...
		var nikayahangkat = this.props.route.params.nikayahangkat;
		var nmayahangkat = this.props.route.params.nmayahangkat;
    ...
    <View style={styles.container}>
     ...
     <WebView
          ...
          source={{
            uri:
              'https://siponcan.disdukcapilsibolga.id/siponcan/aktapengangkatanank.php?nikuser=' +
              nikuser +
			   '&nikpmhon=' +
              nikpmhon +
			    '&namapmhon=' +
		...
		<TouchableOpacity
                onPress={() =>
                  this.props.navigation.navigate('AktaPengangkatananakisian', {nikuser: nikuser,
                     nikpmhon: nikpmhon,
                      namapmhon: namapmhon,
                      nokkpmhon: nokkpmhon,
                      umurpmhon: umurpmhon,
