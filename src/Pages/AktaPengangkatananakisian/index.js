      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView
          ...
          showsVerticalScrollIndicator={false}>
		     ...
		     <Text style={{marginBottom: 20}}>Data Ibu Kandung</Text>
          <TextInput
         ...
         onChangeText={text => this.setState({nikibukandung: text})}
          ...
          />
		  	   ...
		  	   <Text style={{marginBottom: 20}}>Data Ayah Kandung</Text>
          <TextInput
          ...
          />		  
		  <Text style={{marginBottom: 20}}>Data Ibu Angkat</Text>
          <TextInput
          ...
          />  
		    <Text style={{marginBottom: 20}}>Data Ayah Angkat</Text>
          <TextInput
            ...
            style={{backgroundColor: 'white', marginBottom: 25}}
            theme={{roundness: 10}}
            value={this.state.nikayahangkat}
            onChangeText={text => this.setState({nikayahangkat: text})}
          />
          <TextInput
            label="Nama Lengkap Ayah  Angkat"
            mode="outlined"
            activeOutlineColor="#005b9f"
            style={{backgroundColor: 'white', marginBottom: 25}}
            theme={{roundness: 10}}
            value={this.state.nmayahangkat}
            onChangeText={text => this.setState({nmayahangkat: text})}
          />  
       ...
       mode="outlined"
         ...
         onPress={() =>
			...
			<TouchableOpacity
        onPress={() =>
                    this.props.navigation.navigate('AktaPengangkatananakberkas', {
                      nikuser: nikuser,
                      nikpmhon: nikpmhon,
                      namapmhon: namapmhon,
                      nokkpmhon: nokkpmhon,
				...
				pilih_tanggal_pesan1 : pilih_tanggal_pesan1,	  
					penerbit : penerbit,	 
						...
						nikayahangkat : this.state.nikayahangkat,	 
						nmayahangkat : this.state.nmayahangkat,	 
