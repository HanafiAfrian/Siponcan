  ...
  klikSimpan() {
	  ...
	  var namapmhon = this.props.route.params.namapmhon;
	   var nokkpmhon = this.props.route.params.nokkpmhon;
        ...
        var nikpmhon5 = this.state.nikpmhon5;
        var namapmhon5 = this.state.namapmhon5;
        var shdk5 = this.state.selectedcat;
        var ket5 = this.state.ket5;
      ...
      fetch(urlAksi, {
        ...
        .then(responseJson => {
          if (responseJson == 'true') {
            ...
            this.props.navigation.replace('Kkperubahanrincianenam',{
nikuser:nikuser,
nikpmhon : nikpmhon, namapmhon : namapmhon,  nokkpmhon: nokkpmhon, umurpmhon:umurpmhon , kwnpmhon, kwnpmhon,
        ...
        namapmhon4 : this.props.route.params.namapmhon4,
		 ...
		 nikpmhon5 : this.state.nikpmhon5,
         namapmhon5 : this.state.namapmhon5,
         shdk5 : this.state.selectedcat,
         ket5 : this.state.ket5,
