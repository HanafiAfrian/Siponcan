  ...
  klikSimpan() {
	  ...
	  var namapmhon = this.props.route.params.namapmhon;
	   var nokkpmhon = this.props.route.params.nokkpmhon;
        ...
        var nikpmhon4 = this.state.nikpmhon4;
        var namapmhon4 = this.state.namapmhon4;
        var shdk4 = this.state.selectedcat;
        var ket4 = this.state.ket4;
      ...
      fetch(urlAksi, {
        ...
        .then(responseJson => {
          if (responseJson == 'true') {
            ...
            this.props.navigation.replace('Kkperubahanrincianlima',{
				nikuser:nikuser,
        ...
        nikpmhon4 : this.state.nikpmhon4,
        namapmhon4 : this.state.namapmhon4,
         shdk4 : this.state.selectedcat,
         ket4 : this.state.ket4,
